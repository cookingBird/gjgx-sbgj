...
<script>
  ...
  export default {
    ...
    data() {
      return {
        tableCols: [
          { minWidth: 55, type: 'selection', prop: 'selection', align: 'center' },
          {
            minWidth: 55, prop: 'color', align: 'center', label: '顔色', slotIs: 'div',
            dataAttrs: ['colorHex'],
            slotProps({ row }) {
              return {
          ...
          { minWidth: 120, prop: 'taskName', align: 'center', label: '任务名称' },
          ...
          { minWidth: 70, prop: 'hcaLength', align: 'center', label: '长度(m)' },
          { minWidth: void 0, prop: 'beginMileage', align: 'center', label: '起始里程(m)' },
          { minWidth: void 0, prop: 'endMileage', align: 'center', label: '终止里程(m)' },
        ],
        pipeSegmentList: [],
        type: '混合',
        visible: {
