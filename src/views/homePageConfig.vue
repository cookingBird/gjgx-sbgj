  ...
  <div class="HomePage">
    <div class="seach">
      <el-form :inline="true" :model="searchForm">
        <el-form-item label="页面类别" prop="classType">
          <el-select
        ...
        <el-form-item>
          <el-button class="bged" @click="handleCurrentChange(1)"
            >查询</el-button
          >
          <el-button class="bged" @click="openPageDialog(0)"
            >新增公共配置</el-button
          >
          <el-button class="bged" @click="openPageDialog(1)"
            >新增个人配置</el-button
          >
        </el-form-item>
      </el-form>
    ...
    <ul class="concent" v-loading="loading">
      <li class="box" v-for="item in pageList" :key="item.id">
        <el-image :src="item.routeImage" fit="cover">
          <div slot="error" class="image-slot"><span>暂无配置</span></div>
        </el-image>
    ...
    <page-dialog ref="page-dialog" @confirm="handlePageConfirm"></page-dialog>
    <page-preview ref="previewRef" :layout="pageLayout"></page-preview>
  </div>
</template>
